        ...
        <div className="container mx-auto px-4">
            ...
            <div className="flex items-center">
              ...
              <nav className="hidden md:flex space-x-1">
                ...
                <Link href="/schedule" legacyBehavior>
                  <a className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${isActive('/schedule') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-200' : 'hover:bg-gray-100 dark:hover:bg-gray-700'}`}>
                    <span className="flex items-center">
                      <svg className="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out ${menuOpen ? 'max-h-96' : 'max-h-0'}`}>
            <div className="py-2 space-y-1">
              ...
              <Link href="/schedule" legacyBehavior>
                <a className={`block px-3 py-2 rounded-md text-base font-medium ${isActive('/schedule') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-200' : ''}`}>
                  <span className="flex items-center">
                    <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
